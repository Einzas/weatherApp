...
const Weather = ({ weather, temp, theme, handleChangeTheme }) => {
        ...
        <section className="grid gap-4 sm:grid-cols-two ">
          ...
          <article className="bg-slate-300/40 p-2 dark:bg-indigo-800/70 justify-center justify-items-stretch py-2 rounded-3xl grid grid-cols-3 sm:grid-cols-1 sm:px-2 sm:py-2 ">
            <div className="flex gap-2 text-sm justify-center dark:text-white items-center">
              <div>
                <img src="/images/wind.png" className="dark:filter dark:invert" alt="" />
              </div>
              <h5>{weather.wind.speed} m/s</h5>
            </div>
            <div className="flex gap-2 text-sm justify-center dark:text-white items-center">
              <div>
                <img src="/images/humidity.png" className="dark:filter dark:invert" alt="" />
              </div>
              <h5>{weather.main.humidity}%</h5>
            </div>
            <div className="flex gap-2 text-sm justify-center dark:text-white items-center">
              <div>
                <img src="/images/presure.png" className="dark:filter dark:invert" alt="" />
              </div>
        ...
        <div className="grid justify-center items-center pt-5 mt-5">
          ...
          >
            {theme === "light" ? (
              ...
              <img className="w-5 h-3 dark:filter dark:invert" src={"/images/sun.svg"} alt="" />
            )}
          </button>
        </div>
      </section>
